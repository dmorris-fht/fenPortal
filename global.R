...
global_records <- data.frame(
    ...
    "habitat" = character(),
    "note" = character(),
    "record_date" = as.Date(character(),format="%Y-%m-%d"),
    "record_year" = numeric(),
    "record_month" = numeric(),
    "record_date_start" = as.Date(character(),format="%Y-%m-%d"),
    "record_date_end" = as.Date(character(),format="%Y-%m-%d"),
    "recorder" = character(),
    ...
    "verification_date" = as.Date(character(),format="%Y-%m-%d"),
